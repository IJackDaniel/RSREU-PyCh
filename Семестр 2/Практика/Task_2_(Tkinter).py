...
window.geometry('320x450+600+200')
...
rb_hud = tk.Radiobutton(frame_type, variable=rb_var, text="Худи", value=2, command=radiobutton_change)
rb_hud.grid(row=2, column=0, padx=5, pady=5)
rb_pan = tk.Radiobutton(frame_type, variable=rb_var, text="Панамка", value=3, command=radiobutton_change)
rb_pan.grid(row=3, column=0, padx=5, pady=5)
rb_cap = tk.Radiobutton(frame_type, variable=rb_var, text="Кепка", value=4, command=radiobutton_change)
